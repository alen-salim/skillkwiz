    ...
    <div className="text-black">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <label className="w-full bg-[#EFF3F6] shadow-md rounded px-4 py-3 text-black hover:bg-[#444444] flex items-center cursor-pointer">
        ...
        <div>
          ...
          <div className="bg-[#EFF3F6] shadow-md rounded p-4">
        ...
        <div className="flex justify-center gap-4 mt-8">
          <button className="px-10 py-2 rounded bg-[#262730] text-white  hover:opacity-90">
            Submit
          </button>
